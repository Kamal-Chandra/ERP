class TTexts {
  ...
  static const String homeAppbarSubTitle = "Let's go Shopping!";
  ...
  static const String changePasswordSubtitle = "Yor Account Security is Our Priority! We've Sent You a Secure Link to Safely Change Your Password and Keep Your Account Protected.";
  static const String confirmEmailTitle = "Verify your email address!";
  static const String emailNotReceivedMessage = "If you haven't received the email, please check your spam folder or request another email.";
  static const String accountCreatedTitle = "Your Account Successfully Created!";
  static const String accountCreatedSubtitle = "Congratulations! Your account has been successfully created. Start exploring our amazing products and enjoy seamless shopping.";
}