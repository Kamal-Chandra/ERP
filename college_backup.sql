...
INSERT INTO `alumni` VALUES (6,'Aarav Patel',2018,'Infosys','9876543210','aarav.patel@example.com'),(7,'Riya Sharma',2019,'Tata Consultancy Services','9876543211','riya.sharma@example.com'),(8,'Ishaan Mehta',2017,'Wipro','9876543212','ishaan.mehta@example.com'),(9,'Kavya Nair',2020,'HCL Technologies','9876543213','kavya.nair@example.com'),(10,'Aditya Rao',2018,'Reliance Industries','9876543214','aditya.rao@example.com'),(11,'Anika Verma',2019,'Larsen & Toubro','9876543215','anika.verma@example.com'),(12,'Rohan Singh',2016,'Mahindra & Mahindra','9876543216','rohan.singh@example.com'),(13,'Sanya Gupta',2021,'Tech Mahindra','9876543217','sanya.gupta@example.com'),(14,'Vikram Deshmukh',2015,'Accenture','9876543218','vikram.deshmukh@example.com'),(15,'Mira Kapoor',2018,'Capgemini','9876543219','mira.kapoor@example.com');
...
INSERT INTO `applications` VALUES (16,6,7),(17,7,6),(18,8,8),(19,9,9),(20,10,6),(21,11,7),(22,12,10),(23,13,8),(24,14,9),(25,15,10);
...
INSERT INTO `books` VALUES (1,'Introduction to Algorithms','Thomas H. Cormen','9780262033848',10,5),(2,'The Art of Electronics','Paul Horowitz','9780521809269',5,1),(3,'Digital Design and Computer Architecture','David Harris','9780123944245',8,4),(4,'Engineering Mechanics: Dynamics','J.L. Meriam','9781118885840',6,4),(5,'Thermodynamics: An Engineering Approach','Yunus A. Çengel','9780073398174',7,6),(6,'Mechanics of Materials','R.C. Hibbeler','9780134319650',4,2),(7,'Physics for Scientists and Engineers','Raymond A. Serway','9781133947271',9,7),(8,'Introduction to Quantum Mechanics','David J. Griffiths','9781107189638',6,4),(9,'Calculus: Early Transcendentals','James Stewart','9781285741550',10,8),(10,'Linear Algebra and Its Applications','Gilbert Strang','9780030105678',8,6),(26,'Fundamentals of Engineering Thermodynamics','Michael J. Moran','9781118412930',7,5),(27,'Signals and Systems','Alan V. Oppenheim','9780138147570',6,4),(28,'Advanced Engineering Mathematics','Erwin Kreyszig','9780470458365',8,6),(29,'Chemistry: The Central Science','Theodore E. Brown','9780134414232',5,3),(30,'Principles of Electronic Materials and Devices','S.O. Kasap','9780073399995',9,7),(31,'Control Systems Engineering','Norman S. Nise','9781118170519',6,4),(32,'Fluid Mechanics','Frank M. White','9780073398273',8,6),(33,'Introduction to Linear Algebra','Gilbert Strang','9780980232776',7,5),(34,'Design and Analysis of Experiments','Douglas C. Montgomery','9781118146927',5,4),(35,'Structural Analysis','Russell C. Hibbeler','9780134610672',6,4),(36,'Introduction to Robotics: Mechanics and Control','John J. Craig','9780201543612',8,6),(37,'Microelectronic Circuits','Adel S. Sedra','9780199339136',7,5),(38,'Introduction to Electrodynamics','David J. Griffiths','9780321856562',6,4),(39,'Engineering Circuit Analysis','William H. Hayt','9780073529578',7,5),(40,'Foundations of Materials Science and Engineering','William F. Smith','9780073598429',8,6);
...
CREATE TABLE `companies` (
  ...
  `eligible_students` int DEFAULT NULL,
  `applications` int DEFAULT NULL,
  `shortlisted` int DEFAULT NULL,
  `recruited` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `companies` VALUES (6,'Tata Consultancy Services','Software Developer','B.Tech with 60%+ marks, no active backlogs',100,75,30,15),(7,'Infosys','System Engineer','B.Tech with 65%+ marks, no backlogs',90,70,25,12),(8,'Wipro','Project Engineer','B.Tech with 60%+ marks',85,60,20,10),(9,'HCL Technologies','Analyst','B.Tech with 55%+ marks, max 2 backlogs',95,65,28,14),(10,'Accenture','Consultant','B.Tech with 60%+ marks, strong communication skills',80,50,22,11),(11,'Reliance Industries','Data Analyst','B.Tech with 70%+ marks, no backlogs',75,55,20,8),(12,'Larsen & Toubro','Mechanical Engineer','B.Tech Mechanical with 65%+ marks',60,40,18,7),(13,'Tech Mahindra','Support Engineer','B.Tech with 55%+ marks',70,50,15,9),(14,'Mahindra & Mahindra','Field Engineer','B.Tech with 60%+ marks',50,35,10,5),(15,'Capgemini','Business Analyst','B.Tech with 65%+ marks, excellent problem-solving skills',65,45,12,6);
...
CREATE TABLE `faculty_feedback` (
  ...
  KEY `fk_faculty` (`giver_id`),
  CONSTRAINT `fk_faculty` FOREIGN KEY (`giver_id`) REFERENCES `instructor` (`id`) ON DELETE CASCADE
...
INSERT INTO `faculty_feedback` VALUES (1,101,'Projector not working in room 204','unresolved','2024-11-03','Projector not working in CR204');
...
INSERT INTO `image` VALUES (3,'https://images.pexels.com/photos/28956203/pexels-photo-28956203/free-photo-of-forbidden-city-ancient-architecture-in-beijing.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'),(10,'https://images.pexels.com/photos/5075266/pexels-photo-5075266.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'),(11,'https://images.pexels.com/photos/6963405/pexels-photo-6963405.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');
...
INSERT INTO `instructor` VALUES (101,'Anil','Kumar','CSE'),(102,'Priya','Sharma','ECE'),(103,'Sunita','Deshmukh','ECI'),(104,'Deepa','Singh','CSE'),(105,'Raj','Sharma','CSA'),(106,'Sneha','Menon','CSD'),(107,'Pooja','Nair','CSH'),(108,'Ravi','Reddy','ECI'),(109,'Sanjay','Kumar','ECE'),(110,'Amit','Patel','CSA'),(111,'Meera','Iyer','CSA'),(112,'Vikram','Joshi','CSD'),(113,'Kiran','Shetty','CSD'),(114,'Ramesh','Chawla','CSE'),(115,'Anita','Garg','CSE'),(116,'Vasudha','Bhatt','CSH'),(117,'Tarun','Malik','CSH'),(118,'Rekha','Pandey','ECI'),(119,'Siddharth','Nanda','ECI'),(120,'Naveen','Mehra','ECE'),(121,'Gauri','Sharma','ECE'),(122,'Mohit','Kapoor','CSA'),(123,'Neha','Singh','CSD'),(124,'Aarti','Chopra','CSE'),(125,'Varun','Bose','CSH');
...
INSERT INTO `issued_books` VALUES (1,1,'student',101,'2024-11-03',NULL),(2,2,'student',101,'2024-11-03',NULL),(3,1,'faculty',101,'2024-11-03',NULL),(4,2,'faculty',101,'2024-11-03',NULL),(5,3,'faculty',101,'2024-11-03',NULL);
...
CREATE TABLE `notice` (
  ...
  `notice_type` enum('Event','Exam','General','Fee') DEFAULT 'General',
...
INSERT INTO `notice` VALUES (32,'Even Semester Fee','Students are required to pay the even semester fee by December 25, 2024.','2024-11-05','21:48:09','Fee','High',''),(33,'Hostel Fee','Students are required to pay hostel fee by December 20, 2024.','2024-11-05','21:48:42','Fee','High',''),(34,'End Semester Exam','End Semester Exam for 2nd and 3rd year students will be held from November 21, 2024 to December 3, 2024.','2024-11-05','21:49:37','Exam','High','');
...
INSERT INTO `slider` VALUES (4,'Tantra Fiesta 2024','https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg'),(5,'Diwali 2024','https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'),(6,'Diwali 2024','https://images.pexels.com/photos/1387577/pexels-photo-1387577.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');
...
CREATE TABLE `student_feedback` (
  ...
  `feedback_text` text NOT NULL,
  PRIMARY KEY (`feedback_id`),
  KEY `fk_student` (`giver_id`),
  CONSTRAINT `fk_student` FOREIGN KEY (`giver_id`) REFERENCES `student` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `students` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `status` enum('applied','shortlisted','recruited') DEFAULT 'applied',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `students` VALUES (6,'Rahul Gupta','applied'),(7,'Ananya Sharma','shortlisted'),(8,'Priya Singh','recruited'),(9,'Amit Verma','applied'),(10,'Sneha Patel','shortlisted'),(11,'Rohan Joshi','recruited'),(12,'Kavya Iyer','applied'),(13,'Arjun Desai','shortlisted'),(14,'Meera Menon','recruited'),(15,'Nikhil Chawla','applied');
...
CREATE TABLE `ticker` (
  ...
  `time_posted` time DEFAULT (curtime()),
  `display_until` date DEFAULT ((curdate() + interval 7 day)),
...
INSERT INTO `ticker` VALUES (8,'Happy Diwali to all students and faculty members.','2024-11-05','21:50:11','2024-11-12'),(9,'End semester exam will start from November 21, 2024.','2024-11-05','21:51:09','2024-11-12');
...
INSERT INTO `video` VALUES (17,'Convocation Ceremony','https://www.youtube.com/watch?v=0oyDqO8PjIg'),(18,'Orientation Ceremony','https://www.youtube.com/watch?v=6A52M3b7tl8'),(19,'Tantra Fiesta DJ Night','https://youtu.be/uTMWXQ7iEj4?si=o0z3Xc7vOnBX0sou');
...
-- Dump completed on 2024-11-10 16:51:04
